...
class LearnVideoResponse(BaseModel):
    ...
    @staticmethod
    def from_orm(obj):
        """Override from_orm to compute embed_url."""
        data = {
            "id": obj.id,
            "title": obj.title,
            ...
            "embed_url": f"https://www.youtube.com/embed/{obj.youtube_video_id}"
        }
        return LearnVideoResponse(**data)
...
class QuizQuestionResponse(BaseModel):
    """Response schema for quiz question (excludes correct_option for security)."""
    id: int
    question_text: str
    option_a: str
    option_b: str
...
class QuizResponse(BaseModel):
    """Response schema for a quiz with all its questions."""
    id: int
    title: str
    video_id: int
...
class QuizSubmitResponse(BaseModel):
    """Response schema for quiz submission results."""
    total_score: int
    correct_count: int
    total_questions: int
    xp_earned: int
...
@app.post("/api/learn/seed-v2", response_model=SimpleResponse)
def seed_learn_v2(db: Session = Depends(get_db)):
    """
    POST /api/learn/seed-v2
    
    Seeds database with 12 educational videos (3 modules of 4 videos each)
    and automatically generates quizzes with 10 questions each.
    
    Categories:
    - Basics (4 videos)
    - Mutual Funds (4 videos)
    ...
    videos_data = [
        # MODULE 1: BASICS (Videos 1-4)
        {
            "title": "Stock Market Basics for Beginners",
            "description": "Learn the fundamentals of stock market investing, how exchanges work, and basic terminology.",
            "thumbnail_url": "https://img.youtube.com/vi/p7HKvqRI_Bo/maxresdefault.jpg",
            "youtube_video_id": "p7HKvqRI_Bo",
            "category": "Basics",
            "duration_minutes": 15,
        ...
        },
        {
            ...
            "description": "Discover what bull and bear markets mean and how to invest in different market conditions.",
            "thumbnail_url": "https://img.youtube.com/vi/gvZSpET11ZY/maxresdefault.jpg",
        ...
        },
        {
            ...
            "description": "Master the basics of candlestick charts, trends, and technical analysis for beginners.",
            "thumbnail_url": "https://img.youtube.com/vi/08Ebh8_PKt4/maxresdefault.jpg",
            "youtube_video_id": "08Ebh8_PKt4",
            "category": "Basics",
            "duration_minutes": 18,
            "is_featured": False,
            "order_index": 3
        },
        {
            ...
            "thumbnail_url": "https://img.youtube.com/vi/g2PLUwI6GTc/maxresdefault.jpg",
            "youtube_video_id": "g2PLUwI6GTc",
            "category": "Basics",
            "duration_minutes": 14,
            "is_featured": False,
            "order_index": 4
        ...
        # MODULE 2: MUTUAL FUNDS (Videos 5-8)
        {
            "title": "What is a Mutual Fund?",
            "description": "Understand how mutual funds work, their benefits, and how to choose the right fund.",
            "thumbnail_url": "https://img.youtube.com/vi/UZgRHNvOXFk/maxresdefault.jpg",
            "youtube_video_id": "UZgRHNvOXFk",
            "category": "Mutual Funds",
            "duration_minutes": 12,
        ...
        {
            "title": "SIP Explained: Systematic Investment Plan",
            "description": "Step-by-step guide to starting your first SIP and building wealth systematically.",
            "thumbnail_url": "https://img.youtube.com/vi/Xr3lBXPWw30/maxresdefault.jpg",
            "youtube_video_id": "Xr3lBXPWw30",
            "category": "Mutual Funds",
            "duration_minutes": 10,
        ...
        },
        {
            ...
            "description": "Compare passive index funds with actively managed funds and learn which suits you best.",
            "thumbnail_url": "https://img.youtube.com/vi/fvGLnthJDsg/maxresdefault.jpg",
        ...
        {
            "title": "Equity vs Debt Mutual Funds",
            "description": "Understand the differences between equity and debt funds and how to balance your portfolio.",
            "thumbnail_url": "https://img.youtube.com/vi/RkyXOH6laXA/maxresdefault.jpg",
        ...
        # MODULE 3: PERSONAL FINANCE (Videos 9-12)
        {
            "title": "Personal Finance 101: Budgeting Tips",
            "description": "Essential budgeting tips using the 50/30/20 rule to manage your monthly expenses.",
            "thumbnail_url": "https://img.youtube.com/vi/HQzoZfc3GwQ/maxresdefault.jpg",
            "youtube_video_id": "HQzoZfc3GwQ",
        ...
        {
            "title": "Emergency Fund: How Much Do You Need?",
            "description": "Learn why you need an emergency fund and how to calculate the right amount for you.",
            "thumbnail_url": "https://img.youtube.com/vi/g03D26RswUM/maxresdefault.jpg",
            "youtube_video_id": "g03D26RswUM",
            "category": "Personal Finance",
            "duration_minutes": 9,
            "is_featured": False,
            "order_index": 10
        },
        {
            ...
            "description": "Understand how credit scores work in India and how to improve yours.",
            "thumbnail_url": "https://img.youtube.com/vi/QZUHy46R5lU/maxresdefault.jpg",
            "youtube_video_id": "QZUHy46R5lU",
            "category": "Personal Finance",
            "duration_minutes": 14,
            "is_featured": False,
            "order_index": 11
        },
        {
            ...
            "description": "Explore tax-saving investment options available under Section 80C in India.",
            "thumbnail_url": "https://img.youtube.com/vi/1BYs84vegLk/maxresdefault.jpg",
    ...
    # Sample quiz questions templates for variety
    question_templates = [
        {
            "question": "What is the primary purpose of this topic?",
            "options": ["To make profit", "To understand fundamentals", "To speculate", "To trade daily"],
            "correct": "B"
        },
        {
            "question": "Which of the following is a key benefit?",
            "options": ["Guaranteed returns", "Risk diversification", "Zero risk", "Instant wealth"],
            "correct": "B"
        },
        {
            "question": "What should beginners focus on first?",
            "options": ["Day trading", "Learning basics", "Complex strategies", "Borrowing money"],
            "correct": "B"
        },
        {
            "question": "Which statement is TRUE about long-term investing?",
            "options": ["It's riskier than short-term", "It requires daily monitoring", "It benefits from compounding", "It guarantees profits"],
            "correct": "C"
        },
        {
            "question": "What is a common mistake investors make?",
            "options": ["Diversifying portfolio", "Emotional decision making", "Research before investing", "Setting goals"],
            "correct": "B"
        },
        {
            "question": "How important is financial literacy?",
            "options": ["Not important", "Somewhat important", "Very important", "Only for experts"],
            "correct": "C"
        },
        {
            "question": "What does risk tolerance mean?",
            "options": ["Ability to take losses", "Willingness to accept uncertainty", "Avoiding all risks", "Guaranteed safety"],
            "correct": "B"
        },
        {
            "question": "Which is better for beginners?",
            "options": ["High risk investments", "Systematic regular investing", "Timing the market", "Borrowing to invest"],
            "correct": "B"
        },
        {
            "question": "What role does patience play in investing?",
            "options": ["No role", "Minor role", "Critical role", "Only for old people"],
            "correct": "C"
        },
        {
            "question": "What should you do before investing?",
            "options": ["Borrow money", "Follow tips blindly", "Do research and learn", "Invest all savings"],
            "correct": "C"
        }
    ]
    
    # Create videos, quizzes, and questions
    video_count = 0
    quiz_count = 0
    question_count = 0
    ...
    return {
        "message": f"✅ Successfully seeded {video_count} videos, {quiz_count} quizzes, and {question_count} questions!"
    }
...
def get_quiz(video_id: int, db: Session = Depends(get_db)):
    ...
    Security: Does NOT return correct_option field to prevent cheating.
    """
    ...
    # Get all questions (Pydantic will exclude correct_option automatically)
...
@app.post("/api/learn/quiz/submit", response_model=QuizSubmitResponse)
def submit_quiz(request: QuizSubmitRequest, db: Session = Depends(get_db)):
    """
    POST /api/learn/quiz/submit
    
    Accepts: User Email, Quiz ID, and Dictionary of Answers {question_id: "A"}
    
    Logic:
    - Compares user answers with correct_option from database
    - Calculates score: 10 XP per correct answer
    - One-time reward: Awards XP only if user hasn't completed this quiz before
    - Saves attempt to UserQuizAttempt table
    
    Returns: Total score, correct count, and XP earned
    """
    # Find user
    user = db.query(models.User).filter(models.User.email == request.email.lower()).first()
    if not user:
    ...
    for question in questions:
        ...
        user_answer = request.answers.get(question_id_str, "").upper()
        
        if user_answer == question.correct_option:
            correct_count += 1
            total_score += question.xp_value
    ...
    if not existing_attempt:
        xp_earned = total_score
        user.xp = (user.xp or 0) + xp_earned
        message = f"Great job! You earned {xp_earned} XP!"
    else:
        message = "Quiz completed! No XP awarded (already completed once)."
    
    # Save the attempt
    new_attempt = models.UserQuizAttempt(
        user_id=user.id,
        quiz_id=quiz.id,
        score=correct_count,
...
@app.get("/api/learn/combined-quiz/{module_number}")
def get_combined_quiz(module_number: int, db: Session = Depends(get_db)):
    """
    GET /api/learn/combined-quiz/{module_number}
    
    Returns 10-15 random questions from a block of videos.
    Module 1: Videos #1-4
    Module 2: Videos #5-8
    """
    # Determine video ID range based on module number
    if module_number == 1:
        video_start, video_end = 1, 4
    elif module_number == 2:
        video_start, video_end = 5, 8
    else:
        raise HTTPException(status_code=400, detail="Invalid module number. Use 1 or 2.")
    
    # Get quizzes for videos in this range
    quizzes = db.query(models.Quiz).filter(
        models.Quiz.video_id >= video_start,
        models.Quiz.video_id <= video_end
    ).all()
    ...
    # Randomly select 10-15 questions
    import random
    num_questions = min(15, len(all_questions))
    num_questions = max(10, num_questions)  # At least 10, or all if less than 10
    selected_questions = random.sample(all_questions, min(num_questions, len(all_questions)))
    
    # Format response (excluding correct_option)
    questions_response = []
